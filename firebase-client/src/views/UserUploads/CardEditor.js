...
export default class CardEditor extends Component { 
  state = {
    src: `https://grimoire.imgix.net/images%2F26bed7f1-aa35-4f93-8739-becd7474123f.jpeg?alt=media&token=82a59986-518d-4aa1-8826-719f4f3bbfc8&txt-color=white&txt-size=75&txt-align=bottom%2Ccenter&w=125&txt-font=monospace`,
  ...
  handleClickVibrant = e => {
    this.setState({ imgixParams: { auto: 'enhance', sat: 50, con: 25, fit: 'clip', w: 500, h: 1000 } })
  }

  handleClickClassic = e => {
      this.setState({ imgixParams: { auto: 'enhance', fit: 'clip', w: 500, h: 1000, sat: 50, con: 25, monochrome: 484646 } })
    }

  handleClickVintage = e => {
    this.setState({ imgixParams: { auto: 'enhance', fit: 'clip', w: 500, h: 1000, sat: 50, con: 25, sepia: 70 } })
  }

  handleClickOriginal = e => {
    this.setState({ imgixParams: { auto: 'enhance', fit: 'clip', w: 500, h: 1000 } })
  }
